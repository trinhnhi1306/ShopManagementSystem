...
//    private final ImportHistoryFileManagement fileManagement = new ImportHistoryFileManagement();
...
//        jTextField_IngredientID.setText(String.valueOf(ingredient.getId()));
//        jTextField_IngredientName.setText(ingredient.getName());
//        jSpinner_ImportAmount.setValue(1);
...
//                int amount = (int) jSpinner_ImportAmount.getValue();
//                double cost = amount * ingredient.getCost();
//                jTextField_Cost.setValue(cost);
//            }
//        });
//    }
    ...
    private void initComponents() {
        ...
        jTextField_Cost = new javax.swing.JFormattedTextField();
        ...
        jTextField_Cost.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        jPanel_InfoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_InfoLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_InfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTextField_Name, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
                    .addGroup(jPanel_InfoLayout.createSequentialGroup()
...
//    private IngredientPanel getParentPanel() {
//        return ((IngredientPanel) this.parentPanel);
//    }
...
//        this.ingredient.setQuantities(this.ingredient.getQuantities() + addQuantities);
//        ImportHistory detail = new ImportHistory(
//                ingredient.getId(),
//                LocalDateTime.now(),
//                addQuantities,
//                addQuantities * ingredient.getCost(),
//                ingredient.getProviderID()
//        );
//        fileManagement.writeDataIntoFile(detail);
//        this.getParentPanel().reloadIngredientTable();
//        if (!ingredient.isUsed()) {
//            ingredient.setIsUsed(true);
//        }
//        showInfoMessage("Nhập nguyên liệu thành công");
//        this.dispose();
    ...
    private javax.swing.JFormattedTextField jTextField_Cost;
